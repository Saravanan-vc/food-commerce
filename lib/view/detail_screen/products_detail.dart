...
import 'package:food/widgets/bottomsheet_widgets.dart';
...
class ProductsDetail extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
              ...
              Padding(
                ...
                child: Row(
                  children: [
                    ...
                    GestureDetector(
                      onTap: () {
                        BottomSheetWidgets.bottomsheet(context);
                      },
                      child: Container(
                        decoration: const BoxDecoration(
                            color: Fblackcolor01, shape: BoxShape.circle),
                  ...
                  child: ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      return Container(
                        ...
                        width: 50.w,
                        child: Center(
                            child: Image.asset(listofincridient1[index])),
                      );
                    },
                  ),
                ),
                  ...
                  child: ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      return Container(
                        ...
                        width: 50.w,
                        child:
                            Center(child: Image.asset(listofincridient[index])),
                      );
                    },
                  ),
                ),
        ...
        bottomSheet: BottomSheetWidgets.bottomsheet(context));
  }
}
